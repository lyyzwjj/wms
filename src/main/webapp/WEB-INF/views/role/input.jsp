...
<body>
<form name="editForm" action="/role/saveOrUpdate" method="post" id="editForm">
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <select multiple="true" name="permissionIds" class="ui_multiselect01 selected_permission">
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <select multiple="true" name="menuIds" class="ui_multiselect01 selected_menu">
